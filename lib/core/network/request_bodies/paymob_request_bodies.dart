...
class PaymobRequestBodies {
  ...
  static orderRegistrationBody ({required String authToken, required int amount}) => {
  ...
  static paymentKeyRequestBody({required String authToken, required int orderRegistrationId, required int amount}) => {
    "auth_token": authToken,
